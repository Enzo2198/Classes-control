import {
  Avatar, Box, Button, Chip, Grid, List, ListItem, ListItemIcon, ListItemText, Paper, styled,
              ...
              <Box>
                ...
                <Box sx={{display: 'flex', alignItems: 'flex-end', mt: 2, gap: '10px'}}>
                  ...
                  <Box sx={{display: 'flex', ml: 'auto'}}>
                    <Avatar sx={{backgroundColor: '#6c1b9a', width: 36, height: 36}}>B</Avatar>
                    <Avatar sx={{backgroundColor: '#00bcd4', ml: -1, width: 36, height: 36}}>PD</Avatar>
                    <Avatar sx={{backgroundColor: '#9c27b0', ml: -1, width: 36, height: 36}}>TB</Avatar>
                  </Box>
                </Box>
                ...
                <ListItemText
                  primary={
                    <Typography variant="body2">Bài thi
                      <Typography component="span" color="primary" fontWeight="medium">{test.name}</Typography> vừa được tải lên
                    </Typography>
                  }
                  secondary={
