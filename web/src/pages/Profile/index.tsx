            ...
            <Grid container spacing={3}>
              <Grid size={{xs: 12, md: 6}} width={'100%'}>
                ...
                <TextField
                  ...
                  onChange={onChange}
                  onBlur={handleBlur}
                  error={touchedInfo.name && Boolean(helperTexts.name)}
                  helperText={touchedInfo.name && helperTexts.name}
                />
              </Grid>
              ...
              <Grid size={{xs: 12, md: 6}} width={'100%'}>
                ...
                <TextField
                  ...
                  onChange={onChange}
                  onBlur={handleBlur}
                  error={touchedInfo.email && Boolean(helperTexts.email)}
                  helperText={touchedInfo.email && helperTexts.email}
                />
              </Grid>
            </Grid>
          </Box>
            ...
            <Grid container spacing={3}>
              <Grid size={{xs: 12, md: 6}} width={'100%'}>
                ...
                <TextField
                  ...
                  onChange={onChange}
                  onBlur={handleBlur}
                  error={touchedPassword.old_password && Boolean(helperTexts.old_password)}
                  helperText={touchedPassword.old_password && helperTexts.old_password}
                />
              </Grid>
              ...
              <Grid size={{xs: 12, md: 6}} width={'100%'}>
                ...
                <TextField
                  ...
                  onChange={onChange}
                  onBlur={handleBlur}
                  error={touchedPassword.new_password && Boolean(helperTexts.new_password)}
                  helperText={touchedPassword.new_password && helperTexts.new_password}
                />
              </Grid>
              ...
              <Grid size={{xs: 12, md: 6}} width={'100%'}>
                ...
                <TextField
                  ...
                  onChange={onChange}
                  onBlur={handleBlur}
                  error={touchedPassword.confirm_new_password && Boolean(helperTexts.confirm_new_password)}
                  helperText={touchedPassword.confirm_new_password && helperTexts.confirm_new_password}
                />
              </Grid>
            </Grid>
          </Box>
