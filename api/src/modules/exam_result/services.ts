...
import {AnswerServiceToken, ExamResultEntityRepository} from "@/share";
import type {AnswerReqI, AnswerResI, AnswerServiceI, ExamResultReqI, ExamResultResI, ExamResultServiceI} from "@/share";
          ...
          .select(`
            COALESCE(
              JSON_AGG(
                JSON_BUILD_OBJECT(
                  'id', a.id,
                  'question_exam_id', a.question_exam_id,
